                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="card">
                            <?php echo form_open_multipart($action);?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_dropdown('',$category, $article->id_cat,$id_cat); ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_dropdown('',$subcategory, $article->id_subcat,$id_subcat);?>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                ...
                                <?php echo form_input($id_article);?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <img src="<?php if(empty($article->photos)){echo base_url('upload/article/default_article.png');}else{echo base_url('upload/article/'.$article->photos.'');};?>" class="img-fluid pad" width="450px" height="auto">
                                        </div>
                                    </div>
                                </div>    
                            </div>
