                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body table-responsive">
                                <div class="mb-4">
                                    <a href="<?=base_url('dashboard/category/add_category');?>" class="btn btn-xs btn-primary"><b>Add Category</b></a>
                                </div>
                                <table class="table table-bordered" id="tb_category">
                                    <thead>
                                        <tr>
                                            <th width="20px">No</th>
                                            <th>Category</th>
...
<script src="<?=base_url();?>/assets/back/js/tb_category.js"></script>
