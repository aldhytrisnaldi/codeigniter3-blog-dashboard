                            ...
                            <?php echo form_open($action);?>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input($category,$cat->category);?>
                                        <?php echo form_error('category') ?>
                                    </div>
                                </div>
                                <?php echo form_input($id_category,$cat->id_category);?>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-xs btn-primary"><b><?=$button;?></b></button>
                                </div>
                            <?php echo form_close() ?>
                        </div>
                    </div>
